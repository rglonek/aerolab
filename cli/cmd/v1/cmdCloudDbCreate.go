...
type CloudClustersCreateCmd struct {
	...
	Credentials           string   `short:"C" long:"credentials" description:"Create read-write role cluster credentials in format USER:PASSWORD. If not specified, credentials must be created manually." telemetry:"redact"`
